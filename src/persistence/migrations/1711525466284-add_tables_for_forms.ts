...
export class AddTablesForForms1711525466284 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(
            `ALTER TABLE "single_question_value" ADD CONSTRAINT "FK_897355b7b32bed04c20c1eb7cee" FOREIGN KEY ("attributeId") REFERENCES "single_question_attribute"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
        );
        await queryRunner.query(
            `ALTER TABLE "single_question_attribute" ADD CONSTRAINT "FK_b2750c5fe63be39830b063e7cb5" FOREIGN KEY ("questionId") REFERENCES "form_question"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
        );
        await queryRunner.query(
            `ALTER TABLE "form_question" ADD CONSTRAINT "FK_2072351f9e24ad25ffa22bc93bf" FOREIGN KEY ("formId") REFERENCES "form"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
        );
        await queryRunner.query(
